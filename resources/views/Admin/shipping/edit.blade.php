                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Shipping Edit</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Shipping Edit</h4>
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <select class="form-control select2" name="city_id">
                                                                ...
                                                                @foreach ($city as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ $shipping->city_id == $item->id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <input class="form-control" type="text" name="shipping_rule"
                                                                id="name" value="{{ $shipping->shipping_rule }}">
                                                            @error('shipping_rule')
                                                                <span class="error"
                                                                    style="color: red;">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <select class="form-control select2" name="type">
                                                                <option value="">Select</option>
                                                                <option value="Based on Product Price"
                                                                    {{ $shipping->type == 'Based on Product Price' ? 'selected' : '' }}>
                                                                    Based on Product Price</option>
                                                                <option value="Based on Product Weight"
                                                                    {{ $shipping->type == 'Based on Product Weight' ? 'selected' : '' }}>
                                                                    Based on Product Weight</option>
                                                                <option value="Based on Product Quantity"
                                                                    {{ $shipping->type == 'Based on Product Quantity' ? 'selected' : '' }}>
                                                                    Based on Product Quantity</option>
                                                            </select>
                                                            @error('type')
                                                                <span class="error"
                                                                    style="color: red;">{{ $message }}</span>
