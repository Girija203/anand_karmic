                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Blog Post Edit</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Blog Post Edit</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="m-b-30">
                                                <form class="row g-3" method="POST"
                                                    action="{{ route('blog_posts.update', $blog_post->id) }}">
                                                    @csrf
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="form-group row" id="meta-fields-container">
                                                            @foreach ($meta_details as $meta_detail)
                                                                <div class="form-group row meta-field-row">
                                                                    <div class="col-sm-4 mb-4">
                                                                        <label class="col-form-label">Meta Type</label>
                                                                        <select class="form-control select2 meta_type"
                                                                            name="meta_types_id[]">
                                                                            <option value="">Select meta type</option>
                                                                            @foreach ($meta_type as $type)
                                                                                <option value="{{ $type->id }}"
                                                                                    {{ $type->id == $meta_detail->metaKey->metaType->id ? 'selected' : '' }}>
                                                                                    {{ $type->name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="col-sm-4 mb-4">
                                                                        ...
                                                                        <select class="form-control select2 meta_key"
                                                                            name="meta_keys_id[]">
                                                                            <option value="">Select meta key</option>
                                                                            @foreach ($meta_key as $key)
                                                                                <option value="{{ $key->id }}"
                                                                                    {{ $key->id == $meta_detail->meta_keys_id ? 'selected' : '' }}>
                                                                                    {{ $key->name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="col-sm-3 mb-4">
                                                                        <label for="meta_content"
                                                                            class="col-form-label mandatory">Meta
                                                                            Content</label>
                                                                        <input class="form-control" type="text"
                                                                            name="meta_content[]"
                                                                            value="{{ $meta_detail->content }}">
                                                                    </div>
