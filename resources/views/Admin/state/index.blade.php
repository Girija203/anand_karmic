                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">States List</h4>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 rightsetup-details">
                                        <div class="d-flex justify-content-between p-2 bd-highlight">
                                            ...
                                            <div>
                                                <a href="{{ route('states.create') }}" class="icon-link common-color"
                                                    title="Create State">
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            return `
                           <button onclick="editStates(${row.id})" class="icon-link common-color"><i class="ri-edit-box-line" style="font-size: 18px;"></i></button>
                           <button onclick="deleteStates(${row.id})" class="icon-link common-color"><i class="mdi mdi-delete" style="font-size: 18px;"></i></button>
