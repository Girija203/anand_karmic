                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Product Coupon Create</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Product Coupon Create</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="m-b-30">
                                                ...
                                                {{-- <form class="row g-3" method="POST" action="{{ route('coupons.store') }}"> --}}
                                                    @csrf
                                            <input type="text" value="3" hidden id="coupon_type_id" name="coupon_type_id">
                                                    <label for="name"
...
<div>
                                                   <label for="product" class="col-sm-2 col-form-label mandatory">Product</label>
    <div class="row">
        <div class="col-lg-6 col-sm-4 mb-4">
            <select class="form-control select2" name="product" id="product" onchange="updateProductInputField()">
