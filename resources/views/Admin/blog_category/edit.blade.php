                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Blog Category Edit</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="m-b-30">
                                                <form class="row g-3" method="POST"
                                                    action="{{ route('blog_categories.update', $blog_category->id) }}">
                                                    @csrf
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <select class="form-control select2" name="parent_id"
                                                                ...
                                                                @foreach ($categories as $category)
                                                                    <option value="{{ $category->id }}"
                                                                        {{ $blog_category->parent_id == $category->id ? 'selected' : '' }}>
                                                                        {{ $category->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <input class="form-control" type="text" name="name"
                                                                id="name" value="{{ $blog_category->name }}">
                                                            @error('name')
                                                                <span class="error"
                                                                    style="color: red;">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <select class="form-control select2" name="status">
                                                                <option value="1"
                                                                    {{ $blog_category->status == 1 ? 'selected' : '' }}>
                                                                    Active</option>
                                                                <option value="0"
                                                                    {{ $blog_category->status == 0 ? 'selected' : '' }}>
                                                                    Inactive</option>
                                                            </select>
                                                            @error('status')
                                                                <span class="error"
