                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Contact Message List</h4>
                            </div>
                            <div class="alert alert-success alert-dismissible fade show" role="alert"
                                ...
                                <strong></strong> Contact Message deleted successfully.
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 rightsetup-details">
                                        <div class="d-flex justify-content-between p-2 bd-highlight">
                                            ...
                                            <div>
                                                {{-- <a href="{{ route('contact_messages.create') }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('contact_messages.data') }}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
        ...
        function editContact_messages(id) {
            console.log("inside");
            // Redirect to the user edit page or open a modal for editing
            window.location.href = 'contact_message-edit/' + id;
        }

        function deleteContact_messages(id) {
            // Send an AJAX request to delete the user
            if (confirm('Are you sure you want to delete this Contact Message?')) {
                $.ajax({
                    url: 'contact_message-delete/' + id,
                    type: 'get',
                    data: {
                        _token: '{{ csrf_token() }}',
                    },
