                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Product Show Case Create</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Product Show Case Create</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="m-b-30">
                                                <form class="row g-3" method="POST"
                                                    action="{{ route('product_show_cases.store') }}">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-evenly">
                                                            ...
                                                            <a href="{{ route('product_show_cases.index') }}"
