                                ...
                                <div class="row">
                                    <div class="col-md-12 rightsetup-details">
                                        <div class="d-flex justify-content-between p-2 bd-highlight">
                                            ...
                                            <div>
                                                <a href="{{ route('permissions.create') }}" class="icon-link common-color"
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            return `
                           <button onclick="editPermissions(${row.id})" class="icon-link common-color"><i class="ri-edit-box-line" style="font-size: 18px;"></i></button>
                           <button onclick="deletePermissions(${row.id})" class="icon-link common-color"><i class="mdi mdi-delete" style="font-size: 18px;"></i></button>
