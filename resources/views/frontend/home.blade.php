  ...
  @section('content')
      <section class="h-100 position-relative" style="background-color: #000 !important;">
          ...
          <swiper-container class="mySwiper animeslide" direction="vertical" pagination="true" pagination-clickable="true"
              mousewheel="true">
                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-sm-12 order-2 order-sm-1 text-white text-left animated-content">
                              <div class="my-3">
                                  <div
                                      class="d-flex justify-content-center align-items-center flex-column text-white banner_content_section">
                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-sm-6 order-2 order-sm-1 text-white text-left animated-content">
                              ...
                              <div>
                                  <p>
                                      Touch and feel our unique bags collection, we crafted exclusively for women and our
                                      bags design and color make you more attractive and elegant. Choose our bags to enhance
                                      your beauty.
                                  </p>
                              </div>
                              <button class="button">
                          ...
                          <div
                              class="col-sm-6 order-1 order-sm-2 animated-contentright d-flex justify-content-center mobile_none">
                              <div class="glasmorphism">
                                  <img src="{{ asset('frontend/assets/images/karmic/karmic 04.png') }}"
                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-sm-6 order-2 order-sm-1 text-white animated-content" data-aos="fade-right">
                              ...
                              <p>
                                  Karmic bags crafting world’s finest premium handbags for women, All bags are exclusively
                                  handmade. Our limited-edition designs enhance your attractiveness and boost your
                                  confidence.
                              </p>
                              <button class="button">
                                  Shop Now
                          ...
                          <div
                              class="col-sm-6 order-1 order-sm-2 animated-contentright d-flex justify-content-center mobile_none">
                              <div class="glasmorphism">
                                  <img src="{{ asset('frontend/assets/images/karmic/karmic 01.png') }}"
                                      class="img-fluid image w-100" alt="" />
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-sm-6 order-2 order-sm-1 text-white text-left animated-content">
                              ...
                              <p>
                                  Explore more and select stylish and unique handbags to your fashion needs. Our bags make
                                  you more fashion freak to the world.
                              </p>
                              <button class="button">
                                  Shop Now
                                  <svg fill="currentColor" viewBox="0 0 24 24" class="icon">
                          ...
                          <div
                              class="col-sm-6 order-1 order-sm-2 animated-contentright d-flex justify-content-center mobile_none">
                              <div class="glasmorphism">
                                  <img src="{{ asset('frontend/assets/images/karmic/Karmic Bag 14.png') }}"
                                      class="img-fluid image w-100" alt="" />
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-sm-6 order-2 order-sm-1 text-white text-left animated-content">
                              ...
                              <p>
                                  Karmic uses only 100% top quality leathers and ensures long lasting wearable. We produce
                                  all our leathers in our own tanneries and maintain strict quality control throughout the
                                  process.
                              </p>
                              <button class="button">
                                  Shop Now
                          ...
                          <div
                              class="col-sm-6 order-1 order-sm-2 animated-contentright d-flex justify-content-center mobile_none">
                              <div class="glasmorphism">
                                  <img src="{{ asset('frontend/assets/images/karmic/Karmic Bag 10_01.png') }}"
                                      class="img-fluid image w-90" alt="" />
                              </div>
                          </div>
                      </div>
                  </div>
          ...
          <div class="container">
              <div class="row align-items-center">
                  ...
                  <div class="col-lg-6 col-md-12 d-flex justify-content-center">
                      <img src="{{ asset('frontend/assets/images/banners/Karmic - 3.png') }}" alt=""
                          srcset="" class="w-75">
                  </div>
              </div>
          </div>
              ...
              <div class="container">
                  ...
                  <div class="row">
                      @foreach ($showCaseProducts as $showCaseProduct)
                          @php
                              // Check if the product has colors and if a single image exists
                              $imagePath =
                                  'storage/' .
                          ...
                          <div class="col-lg-4 col-md-6 mb-15 ">
                              <div class="card position-relative box-shad" style="overflow: hidden">
                                  ...
                                  <div class="p-2">
                                      <div class="">
                                          @if ($showCaseProduct->product->colors->isNotEmpty() && file_exists(public_path($imagePath)))
                                              <img class="card-img-top object-fit-cover" src="{{ asset($imagePath) }}"
                                                  alt="Product image" width="100%">
                                          @else
                                              {{-- Show default "not found" image if the image does not exist --}}
                                  ...
                                  <div class="card-body">
                                      ...
                                      <div class="d-flex justify-content-between align-items-center my-2">
                                          ...
                                          <div class="d-flex flex-column align-items-end">
                                              @if ($showCaseProduct->product->colors->isNotEmpty())
      ...
      <section class="product-section section-space-ptb back-black">
          <div class="container position-relative">
              ...
              <swiper-container class="mySwiper pano-style position-relative" pagination="true"
                      ...
                      <div class="modal-box-wrapper">
                          <ul class="nav sign-in-tablist" role="tablist">
                              <li class="sign-in-tab--item nav-item" role="presentation">
                                  <a class="sign-in-tab--link active" data-bs-toggle="tab" href="#tab_list_06"
                                      role="tab" aria-selected="true">Login</a>
                              </li>
                              <li class="sign-in-tab--item nav-item" role="presentation">
                                  <a class="sign-in-tab--link" data-bs-toggle="tab" href="#tab_list_07" role="tab"
                                      aria-selected="false" tabindex="-1">Our Register</a>
                              </li>
                          </ul>
                                  ...
                                  <form action="#" class="account-form-box max-w-400 mx-auto">
                                      ...
                                      <div
                                          ...
                                          <label class="label-for-checkbox d-flex gap-1 align-items-center">
                                              <input class="input-checkbox" name="rememberme" type="checkbox"
          ...
          <div class="offcanvas-body">
              <nav class="navbar-mobile-menu">
                  <ul class="mobile-menu">
                      ...
                      <li class="mobile-menu-item">
                          <a href="#" class="mobile-menu-link">Shop <span class="menu-expand"><i
                      ...
                      <li class="mobile-menu-item">
                          <a href="#" class="mobile-menu-link">Product <span class="menu-expand"><i
                                      class="icon-rt-arrow-down"></i></span></a>
                          <ul class="sub-menu">
                              <li>
                                  <a href="#" class="sub-menu-link">
                              ...
                              <li>
                                  ...
                                  <ul class="sub-menu">
                                      <li><a href="product-details-variation-vertical-thumbs.html"
                                              class="megamenu-link">Vertical
                                              Thumbnails</a></li>
                      ...
                      <li class="mobile-menu-item">
                          <a href="#" class="mobile-menu-link">Page <span class="menu-expand"><i
                                      class="icon-rt-arrow-down"></i></span></a>
                          <ul class="sub-menu">
                              <li>
                                  <a href="#" class="sub-menu-link">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div class="swiper product-quickview-lg-active">
                                  <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-1.jpg" alt="product quick view 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-1-1.jpg" alt="product quick view 2"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-2.jpg" alt="product quick view 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-2-2.jpg" alt="product quick view 2"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-3.jpg" alt="product quick view 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-3-3.jpg" alt="product quick view 2"
                                              loading="lazy">
                                      </div>
                                  </div>
                              ...
                              <div class="swiper product-quickview-sm-thum-active mt-2">
                                  <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-1.jpg" alt="small product 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-1-1.jpg" alt="small product 2"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-2.jpg" alt="small product 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-2-2.jpg" alt="small product 2"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-3.jpg" alt="small product 1"
                                              loading="lazy">
                                      </div>
                                      <div class="swiper-slide">
                                          <img src="assets/images/products/product-3-3.jpg" alt="small product 2"
                                              loading="lazy">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="product-item-details-box">
                                  ...
                                  <div class="social-share-wrap d-flex gap-1 mt-3">
                                      ...
                                      <div class="social-share social-share-in-color d-flex gap-2">
                                          ...
                                          <a class="social-share-link twitter" href="https://twitter.com/"
