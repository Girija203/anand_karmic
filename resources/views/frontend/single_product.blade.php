                    ...
                    <div class="swiper product-details-sm-thum-active mt-2">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <img src="{{ asset('storage/' . $image->image) }}" alt="{{ $products->title }} Image" />
                            </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <section class="product-info-wrapper section-space-ptb">
        <div class="container">
            <div class="nav product-tab-info justify-content-center" role="tablist">
                <button class="product-tab-info-link active" data-bs-toggle="tab" data-bs-target="#nav-description" type="button" role="tab">
                    Description
                </button>
                <button class="product-tab-info-link" data-bs-toggle="tab" data-bs-target="#nav-additional-information" type="button" role="tab">
                    Additional Information
                </button>
                <button class="product-tab-info-link" data-bs-toggle="tab" data-bs-target="#nav-reviews" type="button" role="tab">
                    Reviews
                </button>
            </div>
                                ...
                                <form action="{{ route('reviews.store') }}" method="POST">
                                    ...
                                    <div class="comment-form-group">
                                       ...
                                       <div class=" d-flex flex-column">
                                        <div>
                                        <label class="comment-form-label" for="rating">Your rating&nbsp;<span class="required">*</span></label>
