    ...
    <tbody>
        @foreach ($order as $orders)
            <tr>
                ...
                <td>₹{{ number_format($orders->total_amount, 2) }} for {{ $orders->product_qty }} item(s)</td>
                <td>
                    <a href="{{ route('vieworder', $orders->id) }}" class="view">view</a>
                </td>
                <td>
                    @if (\App\Models\OrderCancelRequest::where('order_id', $orders->id)->exists())
                        <button type="button" disabled class="btn btn-danger" data-toggle="modal"
                            data-target="#cancelModal{{ $orders->id }}">
                            Already Order Cancel Request
                        </button>
                    @else
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="cancelModal{{ $orders->id }}" tabindex="-1"
                        aria-labelledby="cancelModalLabel{{ $orders->id }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cancelModalLabel{{ $orders->id }}">Order Cancel</h5>
                                        ...
                                        <div id="account" class="tab-pane" role="tabpanel">
                                                    ...
                                                    <div class="container">
                                                        <div class="picture-container">
                                                            <div class="picture">
                                                                ...
                                                                @else
                                                                    <img src="" class="picture-src rounded-circle"
                                                                        id="wizardPicturePreview" title=""
                                                                        style="display: none;">
                                                                @endif
                                            ...
                                            <form action="{{ route('account.changepassword') }}" method="POST">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div style="position: relative;">
                                                            ...
                                                            <button type="button" class="btn"
                                                                onclick="togglePasswordVisibility('old_password', 'toggleOldPasswordIcon')"
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div style="position: relative;">
                                                            ...
                                                            <button type="button" class="btn"
                                                                onclick="togglePasswordVisibility('new_password_confirmation', 'toggleConfirmPasswordIcon')"
                                                                style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); border: none; background: none;">
                                                ...
                                                <div class="row" style="margin-top:18px !important;">
                                                    <div class="col-sm-3"></div>
                                                    <div class="col-sm-9 text-secondary">
                                                        <button type="submit" class="btn btn-primary px-4">Change
                                                            Password</button>
                                                    </div>
                                                </div>
                                            </form>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="address-name" name="name" required>
                                                            </div>
                                                            <div class="form-group">
