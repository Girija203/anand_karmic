                    ...
                    <div class="modal-box-wrapper">
                        <ul class="nav sign-in-tablist" role="tablist">
                            <li class="sign-in-tab--item nav-item" role="presentation">
                                <a class="sign-in-tab--link active" data-bs-toggle="tab" href="#tab_list_06" role="tab"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">
                                <form action="{{ route('normaluser.login') }}" method="post"
                                    class="account-form-box mx-auto">
                                    @csrf
                                    <div class="single-input-group">
                                        <label class="single-input-label" for="login-username">Email address*</label>
                        <input class="single-input-fild" type="text" id="login-username" name="email" required="" value="{{ Cookie::get('email') ?? '' }}">
                                    </div>

                                    <div class="single-input-group">
                                        <label class="single-input-label" for="login-password">Password*</label>

                                        <!-- Safely handle decryption of password cookie -->
                                        @php
                                            try {
                                                $password = Cookie::get('password')
                                                    ? Crypt::decryptString(Cookie::get('password'))
                                                    : '';
                                            } catch (\Illuminate\Contracts\Encryption\DecryptException $e) {
                                                // If decryption fails, forget the password cookie
                        ...
                        <input class="single-input-fild" type="password" id="login-password" name="password" required="" value="{{ $password }}">
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <label class="label-for-checkbox d-flex gap-1 align-items-center">
                                            <input class="input-checkbox" name="remember_me" type="checkbox"
                                                id="remember_me" {{ Cookie::has('email') ? 'checked' : '' }} />
                                    ...
                                    <div class="button-box">
                                        <button class="btn btn-full btn-md btn-primary">Log in</button>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane fade" id="tab_list_07" role="tabpanel">
                                <form action="{{ route('normaluser.store') }}" method="POST"
                                    class="account-form-box mx-auto">
                                    @csrf
                                    <div class="single-input-gruop">
                                        <label class="single-input-label" for="register-name">Username*</label>
                                        <input class="single-input-fild" type="text" id="register-name" name="name" />
                                        @if ($errors->has('name'))
                                ...
                                >.
                                    ...
                                    <div class="button-box mt-4">
                                        <button type="submit" class="btn btn-full btn-primary btn-md">
                                            Register
                                        </button>
                                    </div>
                                </form>
